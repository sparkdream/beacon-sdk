import { windowRef, Serializer, getSenderId, MessageBasedClient } from '@sparkdreamnft/beacon-core'

import { openCryptobox, secretbox_NONCEBYTES, secretbox_MACBYTES } from '@sparkdreamnft/beacon-utils'
import {
  ExtensionMessage,
